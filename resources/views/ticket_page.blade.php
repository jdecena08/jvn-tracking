...
<body class="justify-center items-center w-full scroll-smooth diagonal-bg">
    ...
    <div class="flex flex-col justify-center items-center pt-20 w-full">
        <div class="flex flex-col justify-center items-center pt-10 w-7/12 gap-8">
            <!--content-->
            <div class="company-bg w-full">
                ...
                <div class="flex flex-row justify-between items-center font-bold px-4 pt-8 pb-4 w-full">
                    <span class="px-4 text-sky-600 hover:text-sky-400 underline underline-offset-1 invisible">View Travel Info</span>
                    <a href="#" class="px-4 text-sky-600 hover:text-sky-400 underline underline-offset-1">View Travel Info</a>
                </div>
            </div>
            <!--content ends here-->
        </div>
