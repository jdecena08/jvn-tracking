...
<div class="flex flex-col justify-center items-center pt-20 w-full">
    <div class="flex flex-col justify-center items-center pt-10 w-11/12 md:w-3/4 gap-8">
        ...
        <div class="flex flex-col items-center text-left text-sm md:text-base gap-2 w-full h-full border bg-white border-emerald-600 rounded-lg shadow">
            <div class="grid grid-cols-5 justify-center items-center text-center md:px-4 py-2 w-full font-semibold text-sm md:text-lg text-white dotted-bg rounded-t-md">
            ...
            <div class="flex flex-col justify-between items-center md:px-4 pb-2 gap-4 w-full">
                <div class="grid grid-cols-5 justify-center items-center text-center w-full"
                id="duplicate-this-by-id">
                    ...
                    <span id="ticket-number" class="font-medium text-green-600">Completed</span>
                </div>
                ...
                id="sample">
                    ...
                    <span id="ticket-number" class="font-medium text-blue-600">Dispatched</span>
                </div>
                ...
                id="sample">
                    ...
                    <span id="ticket-number" class="font-medium text-orange-400">Reserved</span>
                </div>
                ...
                id="sample">
                    ...
                    <span id="ticket-number" class="font-medium text-red-600">Cancelled</span>
                </div>
            </div>
        </div>
